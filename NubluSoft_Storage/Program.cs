...
// Permitir operaciones síncronas (requerido por ZipArchive cuando escribe a Response.Body)
...
// JWT Authentication (id�ntica al Gateway)
...
.AddJwtBearer(options =>
{
    ...
    options.Events = new JwtBearerEvents
    {
        OnAuthenticationFailed = context =>
        {
            ...
            logger.LogWarning("Autenticaci�n fallida: {Message}", context.Exception.Message);
